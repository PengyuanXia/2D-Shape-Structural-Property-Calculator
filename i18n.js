...
const translations = {
  en: {
    ...
    'contact.missionNote': 'Built to keep engineering mechanics free, fast, and 100% ad-free. If this tool saved your coursework or exam prep, consider buying me a coffee to support development!',
  ...
  pl: {
    ...
    'contact.missionNote': 'Stworzone, by edukacja inżynierska była darmowa, szybka i wolna od reklam. Jeśli ten program ułatwił Ci projekt lub naukę do egzaminu, rozważ postawienie symbolicznej kawy!',
